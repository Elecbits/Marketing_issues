...
<body style="font-size: 16px;">
  <div id="sidedrawer" class="border-r mui--no-user-select">
    ...
    <div class="mui-divider"></div>
      ...
      <li>
      <a href="index.php?offers" style="text-decoration: none; color: black;"><strong>Offers</strong></a>
     </li>

      <li>
      <a href="index.php?cust" style="text-decoration: none; color: black;"><strong>Customers</strong></a>
     </li>
     <li>
    <a href="index.php?hoard" style="text-decoration: none; color: black;"><strong>Hoardings</strong></a>
    </li>


     <li>
    <a href="index.php?coins" style="text-decoration: none; color: black;"><strong>Coins</strong></a>
    </li>
